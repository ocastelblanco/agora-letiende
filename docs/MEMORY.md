...
| **Fase** | Autenticación y roles (roadmap #4), Gestión de usuarios (roadmap #5) y CRUD de eventos (roadmap #6) completas y fusionadas (PR #11, 06/08/2026 noche). Cartelera pública (roadmap #7) implementada, PR #12 abierto en `feature/cartelera-publica` (sin fusionar) — bug real de empaquetado de `eventosPublicos` encontrado en staging y corregido (ver §7). Activa: Menú de navegación (roadmap #18, reemplazó a Motor de aforo — ver §9) |
