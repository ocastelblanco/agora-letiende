...
| Bold | 🟡 Backend fusionado y verificado (PR #50); frontend en revisión (PR #51); fix de aforo de `esperando_pago_bold` en revisión (PR #52) | — | v2: pago automático, webhook firmado y reconciliado, botón embebido — falta validación manual final y fusión de PR #51/#52 |
