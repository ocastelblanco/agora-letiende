...
**5 — Reducción de aforo por edición.** Al editar un evento, `sillasTotales` no puede quedar por debajo de las sillas ya vendidas más las reservadas (`PRD.md` §9). Se valida con `ConditionExpression`, no en el cliente.
