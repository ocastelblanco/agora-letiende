 ...
 * redirige a un tab accesible en vez de mostrar de nuevo la pantalla
 * de ingreso. `rutaDestinoParaRol` (única fuente de esta decisión, ver su
 * docstring) prioriza el tab más específico que el rol actual cumple
 * (administrador → `/usuarios`, portero → `/taquilla/puerta`).
 */
