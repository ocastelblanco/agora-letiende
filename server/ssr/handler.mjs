...
//
// `src/server.ts` (compilado por Angular CLI a `dist/agora-letiende/server/server.mjs`)
...
// existe una vez que `npm run build` generó `dist/agora-letiende/server/server.mjs`;
// compilarlo con tsc introduciría una dependencia circular con ese artefacto de build.
import serverlessExpress from '@codegenie/serverless-express';
import { app } from '../../dist/agora-letiende/server/server.mjs';
